              ...
              <div key={os.id} className="rounded-[8px] p-4 bg-[#111111] border border-[#222222] shadow-lg">
                ...
                <div className="flex flex-col gap-4 mt-4 pt-4 border-t border-[#1f1f1f]">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <Link href={`/admin/ordens-servico/${os.id}`} className="flex justify-center items-center py-2.5 rounded-[6px] text-[13px] font-semibold border border-[#222222] bg-[#1a1a1a] text-[#888888] active:bg-[#222]">
                      Editar
                    </Link>
